...
<body class="img">
      ...
      <div class="modal-content">
        ...
        <form action="adminpg.php" method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="desc" class="notedesc">Type</label>
  ...
  <div class="container uuflex my-4">
    <div class="logo"><!--2 clg logos-->
        <h2 class="uuhd">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;User Updates</h2>
    </div>
    <br>
    <form action="adminpg.php" method="POST">
      <div class="form-group">
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this data?")) {
          console.log("yes");
          window.location = `adminpg.php?delete=${sno}`;
